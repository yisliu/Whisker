...
public class ThrowableSpawner : MonoBehaviour
{
	...
	public float sWidth = 10f;
	public float sHeight = 5f;
    ...
    void SpawnObjects()
    {
        ...
        for (int i = 0; i < toSpawn * 3 && spawned < toSpawn; i++)
        {
			...
			Vector3 origin = transform.position + new Vector3(px, 50f, pz);
...
*/
    ...
    void OnDrawGizmosSelected()
    {
		...
		Gizmos.DrawWireCube(transform.position, new Vector3(sWidth, 0.1f, sHeight));
    }
}